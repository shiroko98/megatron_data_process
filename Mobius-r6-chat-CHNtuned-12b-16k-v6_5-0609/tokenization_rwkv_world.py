...
class RWKVWorldTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, errors="replace", pad_token="<|endoftext|>", **kwargs):
        ...
        self._added_tokens_decoder = {0: AddedToken(str(pad_token),lstrip=False, rstrip=False, single_word=False, normalized=True, special=True)}
        super().__init__(
            errors=errors,
            pad_token=pad_token,
            **kwargs,
    ...
    def _convert_token_to_id(self, token):
        ...
        return self.decoder.get(token, self.encoder.get(self.unk_token))
